...
const partners = ["NORTHSTAR", "MONUMENT", "APERTURE", "KINSHIP", "PARALLAX"];
    ...
    <section className="relative overflow-hidden bg-[#f2f2f0] px-5 pb-24 pt-28 sm:px-10 md:pb-36 md:pt-40">
      <div className="mx-auto max-w-[1440px]">
        <Reveal>
          <div className="border-y border-black/10 py-7">
            <p className="mb-7 text-center text-[11px] font-semibold uppercase tracking-[0.2em] text-black/35">
              Trusted infrastructure for modern wealth
            </p>
        ...
        <div className="grid gap-12 pb-20 pt-28 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20 lg:pb-32 lg:pt-40">
          <Reveal>
            <Kicker>One financial home</Kicker>
            <p className="max-w-[360px] text-base font-medium leading-relaxed text-black/40 md:text-lg">
              Built for people who expect clarity from their capital and more from the
              technology managing it.
            </p>
          </Reveal>
          <Reveal delay={0.08}>
            <p className="text-[38px] font-medium leading-[1.05] tracking-[-0.04em] text-black/25 sm:text-[52px] md:text-[64px] lg:text-[72px]">
              Your financial life is complex. <span className="text-[#0a0a0d]">Seeing it clearly shouldn&apos;t be.</span>
            </p>
          </Reveal>
        </div>
    ...
    <section id="assets" className="relative overflow-hidden bg-[#080a09] px-5 py-28 text-white sm:px-10 md:py-40">
      ...
      <div className="mx-auto grid max-w-[1440px] gap-16 lg:grid-cols-[0.78fr_1.22fr] lg:items-center lg:gap-20">
        <Reveal>
          ...
          <SectionTitle light>
            Every asset. <span className="text-white/25">One intelligent view.</span>
          </SectionTitle>
          <p className="mt-7 max-w-[470px] text-base font-medium leading-relaxed text-white/45 md:text-lg">
            Connect banks, brokers, wallets, funds, and private investments. Synex
            turns a fragmented financial life into a single living picture.
          </p>
...
const capabilityCards = [
  {
    ...
    copy: "Securely link the institutions and wallets you already use—without changing how you invest.",
  },
  {
    icon: Layers3,
    number: "02",
    title: "One source of truth",
    copy: "See ownership, allocation, exposure, performance, and cash flow in one precise view.",
  },
  {
    icon: Radar,
    number: "03",
    title: "Always in motion",
    copy: "Live pricing and intelligent alerts keep your financial picture current as markets move.",
  },
];
      ...
      <div className="mx-auto max-w-[1440px]">
        <Reveal className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <p className="max-w-[420px] text-base font-medium leading-relaxed text-black/40 md:text-lg">
            A calmer way to understand what you own, how it&apos;s performing, and what
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_0.82fr] lg:items-end">
          ...
          <Reveal delay={0.08}>
            <p className="max-w-[500px] text-base font-medium leading-relaxed text-black/40 md:text-lg">
              Go beyond balances. Synex reveals concentration, risk, return, and
              opportunity with analytics that feel natural—not overwhelming.
            </p>
          </Reveal>
        </div>
      ...
      <div className="relative mx-auto max-w-[1440px]">
        <Reveal className="text-center">
          ...
          <p className="mx-auto mt-7 max-w-[580px] text-base font-medium leading-relaxed text-white/40 md:text-lg">
            Follow global markets, discover relevant shifts, and understand how every
            movement connects back to your portfolio.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.1} className="relative mx-auto mt-16 max-w-[1100px] md:mt-24">
          ...
          <div className="relative grid min-h-[520px] place-items-center sm:min-h-[650px]">
            ...
            <div className="absolute inset-x-0 bottom-0 grid gap-3 sm:grid-cols-3">
              {[
                ["Market coverage", "32 exchanges"],
                ["Price refresh", "Real time"],
                ["Currencies", "48 tracked"],
              ].map(([label, value]) => (
...
const securityItems = [
  { icon: LockKeyhole, title: "Bank-grade encryption", copy: "Your data is encrypted in transit and at rest with institutional-grade controls." },
  { icon: Fingerprint, title: "You control access", copy: "Multi-factor authentication and granular permissions keep your account yours." },
  { icon: ShieldCheck, title: "Read-only by design", copy: "Connected account credentials never live on Synex and cannot move your money." },
  { icon: BadgeCheck, title: "Continuously monitored", copy: "Automated detection and independent reviews protect the platform around the clock." },
];
      ...
      <div className="mx-auto grid max-w-[1440px] gap-16 lg:grid-cols-[0.86fr_1.14fr] lg:gap-24">
        <Reveal>
          <div className="lg:sticky lg:top-32">
            ...
            <SectionTitle>
              Your wealth stays <span className="text-black/20">yours.</span>
            </SectionTitle>
            <p className="mt-7 max-w-[460px] text-base font-medium leading-relaxed text-black/40 md:text-lg">
              We built Synex so that seeing your complete financial life never means
...
function TestimonialSection() {
  return (
    <section className="bg-[#f2f2f0] px-5 py-28 sm:px-10 md:py-44">
      <Reveal className="mx-auto max-w-[1100px] text-center">
        ...
        <blockquote className="text-[34px] font-medium leading-[1.08] tracking-[-0.04em] text-black/25 sm:text-[48px] md:text-[62px]">
          “For the first time, I can see the whole picture—not a collection of accounts. <span className="text-[#0a0a0d]">Synex gives me the confidence to act.</span>”
        </blockquote>
        <div className="mt-10">
          <p className="text-sm font-semibold text-black/75">Amelia Roth</p>
          <p className="mt-1 text-xs font-medium text-black/30">Founder & private investor</p>
        </div>
      </Reveal>
    </section>
  );
  ...
  return (
    <section id="get-started" className="relative min-h-[720px] overflow-hidden bg-[#0a0b0b] px-5 py-28 text-white sm:px-10 md:grid md:min-h-[820px] md:place-items-center">
      ...
      <Reveal className="relative z-10 mx-auto max-w-[900px] text-center">
        <div className="mb-7 flex justify-center"><Kicker light>Your wealth, in focus</Kicker></div>
        ...
        <p className="mx-auto mt-7 max-w-[510px] text-base font-medium leading-relaxed text-white/40 md:text-lg">
          Bring your financial world together and discover a calmer, smarter way to
          build what comes next.
        </p>
        <a href="#dashboard" className="group mx-auto mt-10 inline-flex items-center gap-4 rounded-full bg-white py-3 pl-3 pr-6 text-sm font-semibold text-black transition-transform hover:scale-[1.02]">
    ...
    <footer className="bg-[#0a0b0b] px-5 pb-8 pt-16 text-white sm:px-10 md:pt-24">
      <div className="mx-auto max-w-[1440px] border-t border-white/10 pt-12">
        <div className="grid gap-14 md:grid-cols-[1.4fr_0.6fr_0.6fr_0.6fr]">
          <div>
            ...
            <p className="mt-5 max-w-[330px] text-sm font-medium leading-relaxed text-white/35">
              A new standard for understanding, managing, and growing your wealth.
            </p>
          </div>
          {[
            ["Platform", ["Dashboard", "Assets", "Analytics", "Markets"]],
        ...
        <div className="mt-16 flex flex-col gap-5 border-t border-white/10 pt-7 text-xs font-medium text-white/25 sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 Synex Wealth Technologies. All rights reserved.</p>
